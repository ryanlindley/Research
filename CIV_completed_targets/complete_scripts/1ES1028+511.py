...
ctn_flag = auto.mask_wl(wl, [1547.5, 1548.73, 1550, 1551, 1552.3, 1553, 1553.95, 1555])  # add custom ctn if needed 
...
x0 =[13, 20.3, auto.Wave2V(1547.3, wl1)] + [13.5, 20.3, auto.Wave2V(1547.8, wl1)] + [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1548.3, wl1)] + [13.5, 20.3, auto.Wave2V(1550.2, wl2)] + [13.5, 20.3, auto.Wave2V(1552.5, wl2)] + [13.5, 20.3, auto.Wave2V(1550.7, wl2)] + [13.5, 20.3, auto.Wave2V(1548.6, wl1)]
feat = [1, 0, 0, 0, 2, 2, 2, 1] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[50, 100]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [-60, 0, 250, 350])
...
CIV_regions = [[-110, 50]]
cont_regions = [[-60, 0], [50, 100], [250, 350]]
