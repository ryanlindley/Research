...
ctn_flag = auto.mask_wl(wl, [1548, 1549.4, 1550.5, 1551.8])  # add custom ctn if needed 
...
x0 =[13.5, 20.3, auto.Wave2V(1548.3, wl1)] + [13.3, 20.3, auto.Wave2V(1549, wl1)]  + [13.3, 20.3, auto.Wave2V(1550.3, wl2)] #+ [13.5, 20.3, auto.Wave2V(1548.3, wl1)] #+ [13, 20.3, auto.Wave2V(1551.5, wl2)] + [13, 20.3, auto.Wave2V(1547.8, wl1)] + [13.3, 20.3, auto.Wave2V(1552.5, wl2)]
...
weak_flag = auto.mask_v(wl, wl2, [-100, -80])
