...
ctn_flag = auto.mask_wl(wl, [1547.2, 1548.4, 1550.2, 1551.5, 1553.2, 1553.9])  # add custom ctn if needed 
...
x0 =[13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1547.6, wl1)] + [13.5, 20.3, auto.Wave2V(1551, wl2)] + [13, 20.3, auto.Wave2V(1547.8, wl1)] + [13.2, 20.3, auto.Wave2V(1552.5, wl2)] + [13.3, 20.3, auto.Wave2V(1551.5, wl2)] + [13.2, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [1, 0, 2, 1, 2, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-60, -20]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [0, 100])
...
CIV_regions = [[-150, 50]]
cont_regions = [[-60, -20], [0, 100], [100, 150], [225, 250]]
