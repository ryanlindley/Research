...
x0 = [13.5, 20.3, auto.Wave2V(1547.5, wl1)] + [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.3, 20.3, auto.Wave2V(1547.6, wl1)] + [13, 20.3, auto.Wave2V(1550.4, wl2)] + [13, 20.3, auto.Wave2V(1550.8, wl2)] #+ [12.8, 20.3, auto.Wave2V(1551.9, wl2)] #+ [13.5, 20.3, auto.Wave2V(1552.9, wl2)] #+ [13.3, 20.3, auto.Wave2V(1551.5, wl2)] + [13.2, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [1, 0, 0, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-200, -150, -45, -20]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [-100, -50, 0, 20])
...
CIV_regions = [[-150, 75]]
cont_regions = [[-200, -150], [-100, -50], [-45, -20], [0, 20]]
