...
ctn_flag = auto.mask_wl(wl, [1544.8, 1546, 1547.2, 1549, 1550.2, 1551.1])  # add custom ctn if needed 
...
x0 =[13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1549, wl1)] + [13.5, 20.3, auto.Wave2V(1547.2, wl1)] + [13.5, 20.3, auto.Wave2V(1550.5, wl2)] + [13.5, 20.3, auto.Wave2V(1549.8, wl2)] + [13.5, 20.3, auto.Wave2V(1549.7, wl2)] + [13.5, 20.3, auto.Wave2V(1548.4, wl1)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 1, 1, 2, 2, 2, 0, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[100, 175]) # add masking for any regions not to be used in combined data
...
CIV_regions = [[-80, 60]]
cont_regions = [[-200, -100], [-100, -50], [100, 175]]
