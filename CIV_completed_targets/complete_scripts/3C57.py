...
ctn_flag = auto.mask_wl(wl, [1547.5, 1548.5, 1550, 1551, 1553, 1555])  # add custom ctn if needed 
...
x0 = [13.2, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1549.5, wl2)] + [13.3, 20.3, auto.Wave2V(1551.4, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549, wl1)] + [13.5, 20.3, auto.Wave2V(1552.3, wl2)] + [13.3, 20.3, auto.Wave2V(1552.8, wl2)] + [13.3, 20.3, auto.Wave2V(1548.2, wl1)] #+ [13.2, 20.3, auto.Wave2V(1552.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
...
weak_flag = auto.mask_v(wl, wl2, [-275, -225, 80, 120])
