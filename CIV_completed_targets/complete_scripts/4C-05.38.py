...
x0 = [13.5, 20.3, auto.Wave2V(1548.1, wl1)] + [13.3, 20.3, auto.Wave2V(1548.3, wl1)] + [13.3, 20.3, auto.Wave2V(1548.8, wl1)] + [13.2, 20.3, auto.Wave2V(1549.2, wl1)] #+ [13, 20.3, auto.Wave2V(1547.6, wl1)] + [13, 20.3, auto.Wave2V(1551, wl2)] #+ [13, 20.3, auto.Wave2V(1548.7, wl1)]
...
strong_flag = auto.mask_v(wl, wl1,[10, 50]) # add masking for any regions not to be used in combined data
