...
ctn_flag = auto.mask_wl(wl, [1548, 1549.3, 1550.5, 1553])  # add custom ctn if needed 
...
auto.plt.plot(v_final, Nv_final)
auto.plt.ylim(0, 1e13)
auto.plt.xlim(-300, 400)
...
CIV_regions = [[-50, 50]]
cont_regions = [[-325, -275], [50, 250], [260, 400]]
