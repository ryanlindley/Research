...
x0 = [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.3, 20.3, auto.Wave2V(1548.8, wl1)] + [13.3, 20.3, auto.Wave2V(1550.3, wl2)] #+ [13.5, 20.3, auto.Wave2V(1551.6, wl2)] + [13.4, 20.3, auto.Wave2V(1550.4, wl2)] #+ [13.3, 20.3, auto.Wave2V(1552.4, wl2)] #+ [13.3, 20.3, auto.Wave2V(1548.2, wl1)] #+ [13.2, 20.3, auto.Wave2V(1552.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 0, 1, 1, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-100, 100]) # add masking for any regions not to be used in combined data
