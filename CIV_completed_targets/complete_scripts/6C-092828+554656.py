...
x0 = [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13.5, 20.3, auto.Wave2V(1550.5, wl2)] + [13.5, 20.3, auto.Wave2V(1549.5, wl2)] + [13.2, 20.3, auto.Wave2V(1552.5, wl2)] #+ [13.3, 20.3, auto.Wave2V(1549, wl2)] + [13.2, 20.3, auto.Wave2V(1550.7, wl2)] #+ [13.3, 20.3, auto.Wave2V(1551.3, wl2)] + [13.4, 20.3, auto.Wave2V(1552, wl2)] + [13.2, 20.3, auto.Wave2V(1552.5, wl2)] #+ [13.3, 20.3, auto.Wave2V(1551.5, wl2)] + [13.2, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
...
weak_flag = auto.mask_v(wl, wl2, [-300, -175, -75, 0, 300, 400])
...
CIV_regions = [[-80, 60]]
cont_regions = [[-300, -175], [-75, 0], [300, 400]]
