...
ctn_flag = auto.mask_wl(wl, [1546.4, 1548.8, 1549.5, 1551.5, 1553.7, 1555])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1547, wl1)]  + [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.2, 20.3, auto.Wave2V(1547.5, wl1)] + [13.5, 20.3, auto.Wave2V(1550.8, wl2)] + [13.2, 20.3, auto.Wave2V(1551.5, wl2)] + [13, 20.3, auto.Wave2V(1547.6, wl1)] #+ [13, 20.3, auto.Wave2V(1546.7, wl1)] #+ [13, 20.3, auto.Wave2V(1547.2, wl1)] + [13, 20.3, auto.Wave2V(1548.5, wl1)]
feat = [0, 0, 0, 2, 2, 1, 1] #which features used to model 0 - both, 1 - strong, 2 - weak
...
weak_flag = auto.mask_v(wl, wl2, [0, 20, 80, 120])
