...
strong_flag = auto.mask_v(wl, wl1,[-400, -250, -175, -100, 25, 75]) # add masking for any regions not to be used in combined data
...
CIV_regions = [[-250, -150], [-100, 100]]
cont_regions = [[-400, -250], [-175, -100], [25, 75]]
