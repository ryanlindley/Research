...
x0 = [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.4, 20.3, auto.Wave2V(1548.4, wl1)] + [13.5, 20.3, auto.Wave2V(1551.4, wl2)] + [13.4, 20.3, auto.Wave2V(1552, wl2)] + [13.5, 20.3, auto.Wave2V(1550.5, wl2)] #+ [13.2, 20.3, auto.Wave2V(1552, wl2)] #+ [13, 20.3, auto.Wave2V(1547.2, wl1)] + [13, 20.3, auto.Wave2V(1548.5, wl1)]
feat = [0, 1, 2, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
weak_flag = auto.mask_v(wl, wl2, [-100, 25, 225, 300])
