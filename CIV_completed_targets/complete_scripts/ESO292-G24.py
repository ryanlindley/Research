...
ctn_flag = auto.mask_wl(wl, [1547.5, 1548.5, 1550, 1551.5])  # add custom ctn if needed 
...
strong_flag = auto.mask_v(wl, wl1,[-240, -220]) # add masking for any regions not to be used in combined data
