...
x0 = [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13.5, 20.3, auto.Wave2V(1548.4, wl1)] + [13.3, 20.3, auto.Wave2V(1549, wl1)] + [13.5, 20.3, auto.Wave2V(1549.2, wl1)] + [13.5, 20.3, auto.Wave2V(1549.2, wl1)] + [13.4, 20.3, auto.Wave2V(1550.5, wl2)] #+ [13.3, 20.3, auto.Wave2V(1551.3, wl2)] + [13.5, 20.3, auto.Wave2V(1552.5, wl2)] + [13.5, 20.3, auto.Wave2V(1546.6, wl1)] #+ [13.5, 20.3, auto.Wave2V(1551.8, wl2)]
feat = [0, 0, 0, 0, 1, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[160, 200]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [-60, -40])
