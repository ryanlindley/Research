...
ctn_flag = auto.mask_wl(wl, [1547, 1548.5, 1550, 1551, 1553, 1555])  # add custom ctn if needed 
...
x0 = [13, 20.3, auto.Wave2V(1547.5, wl1)] + [13.5, 20.3, auto.Wave2V(1548, wl1)] #+ [13.3, 20.3, auto.Wave2V(1548, wl1)] + [13.3, 20.3, auto.Wave2V(1550.2, wl2)]  #+ [13, 20.3, auto.Wave2V(1547.6, wl1)] + [13, 20.3, auto.Wave2V(1551, wl2)] #+ [13, 20.3, auto.Wave2V(1548.7, wl1)]
feat = [0, 0] #which features used to model 0 - both, 1 - strong, 2 - weak
