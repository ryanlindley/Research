...
ctn_flag = auto.mask_wl(wl, [1547.5, 1548.5, 1549, 1550, 1550.4, 1551])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1547.4, wl1)] + [13.5, 20.3, auto.Wave2V(1547.8, wl1)] + [13.5, 20.3, auto.Wave2V(1548.1, wl1)] + [13.3, 20.3, auto.Wave2V(1548.4, wl1)] + [13.5, 20.3, auto.Wave2V(1549.3, wl2)] + [13.5, 20.3, auto.Wave2V(1550.6, wl2)] + [13.5, 20.3, auto.Wave2V(1550.8, wl2)] + [13.3, 20.3, auto.Wave2V(1552.4, wl2)] #+ [13.3, 20.3, auto.Wave2V(1548.2, wl1)] #+ [13.2, 20.3, auto.Wave2V(1552.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [1, 0, 0, 0, 2,2 ,2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-200, -150]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [-50, 50, 250, 400])
...
CIV_regions = [[-100, 80]]
cont_regions = [[-300, -200], [-275, -225], [-200, -150], [-50, 50], [250, 400]]
