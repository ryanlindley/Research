...
x0 =[13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1549.8, wl2)] + [13.5, 20.3, auto.Wave2V(1550.6, wl2)] + [13, 20.3, auto.Wave2V(1551, wl2)] #+ [13.5, 20.3, auto.Wave2V(1550, wl2)] + [13.3, 20.3, auto.Wave2V(1548.2, wl1)] + [13.2, 20.3, auto.Wave2V(1552, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 2, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
weak_flag = auto.mask_v(wl, wl2, [-250, -150, -100, 100])
