...
ctn_flag = auto.mask_wl(wl, [1547, 1549.2, 1549.7, 1551.5])  # add custom ctn if needed 
...
x0 = [13.2, 20.3, auto.Wave2V(1547.5, wl1)] + [13.5, 20.3, auto.Wave2V(1547.8, wl1)] + [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13.3, 20.3, auto.Wave2V(1548.6, wl1)] + [13.5, 20.3, auto.Wave2V(1549, wl1)] + [13.5, 20.3, auto.Wave2V(1552.3, wl2)] + [13.3, 20.3, auto.Wave2V(1552.8, wl2)] + [13.3, 20.3, auto.Wave2V(1548.2, wl1)] #+ [13.2, 20.3, auto.Wave2V(1552.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 0, 0, 0, 1, 2, 2, 1] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[150, 200]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [275, 400])
...
CIV_regions = [[-225, -100], [-100, 150]]
cont_regions = [[150, 200], [275, 400]]
