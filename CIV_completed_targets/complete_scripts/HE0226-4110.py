...
x0 = [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13.5, 20.3, auto.Wave2V(1548.3, wl1)] + [13.5, 20.3, auto.Wave2V(1548.6, wl1)] + [13.4, 20.3, auto.Wave2V(1549, wl1)] + [13.4, 20.3, auto.Wave2V(1549.3, wl1)] + [13.5, 20.3, auto.Wave2V(1549.5, wl1)] + [13.5, 20.3, auto.Wave2V(1550, wl2)] + [13.5, 20.3, auto.Wave2V(1551.4, wl2)] + [13.5, 20.3, auto.Wave2V(1549.2, wl1)] #+ [13.5, 20.3, auto.Wave2V(1551.8, wl2)]
feat = [1, 0, 1, 1, 1, 1, 2, 2, 1] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[10, 280]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [-150, -100])
...
CIV_regions = [[-75, 110]]
cont_regions = [[-150, -100], [10, 280], [160, 250]]
