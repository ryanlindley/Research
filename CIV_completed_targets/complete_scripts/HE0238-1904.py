...
ctn_flag = auto.mask_wl(wl, [1553, 1555])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13.3, 20.3, auto.Wave2V(1548.5, wl1)] + [13.5, 20.3, auto.Wave2V(1550, wl2)] + [13.6, 20.3, auto.Wave2V(1550.3, wl2)] #+ [13.3, 20.3, auto.Wave2V(1550.4, wl2)] + [13.3, 20.3, auto.Wave2V(1550.8, wl2)] #+ [13.2, 20.3, auto.Wave2V(1552.6, wl2)] + [13.4, 20.3, auto.Wave2V(1549.4, wl2)] #+ [13.2, 20.3, auto.Wave2V(1552.5, wl2)] + [13.3, 20.3, auto.Wave2V(1551.5, wl2)] + [13.2, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
...
weak_flag = auto.mask_v(wl, wl2, [-160, -140, 60, 100])
