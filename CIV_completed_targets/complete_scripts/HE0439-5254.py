...
ctn_flag = auto.mask_wl(wl, [1546.5, 1547.4, 1547.8, 1548.9, 1549.5, 1550, 1550.5, 1551.5])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1549.8, wl1)] + [13.5, 20.3, auto.Wave2V(1549.5, wl1)] + [13.3, 20.3, auto.Wave2V(1550.4, wl2)] + [13, 20.3, auto.Wave2V(1552.5, wl2)] #+ [13, 20.3, auto.Wave2V(1549.2, wl1)] #+ [13.3, 20.3, auto.Wave2V(1552.8, wl2)] + [13.3, 20.3, auto.Wave2V(1548.2, wl1)] #+ [13.2, 20.3, auto.Wave2V(1552.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 1, 1, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[225, 400]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [-75, 50])
