...
ctn_flag = auto.mask_wl(wl, [1543, 1544.5, 1546.5, 1548.5, 1550.2, 1551])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13.3, 20.3, auto.Wave2V(1549.2, wl1)] + [13.5, 20.3, auto.Wave2V(1547.4, wl1)] + [13.5, 20.3, auto.Wave2V(1549.6, wl2)] + [13.4, 20.3, auto.Wave2V(1549.8, wl2)] + [13.3, 20.3, auto.Wave2V(1551.3, wl2)] + [13.5, 20.3, auto.Wave2V(1552.5, wl2)] + [13.5, 20.3, auto.Wave2V(1546.6, wl1)] #+ [13.5, 20.3, auto.Wave2V(1551.8, wl2)]
feat = [0, 0, 0, 1, 2, 2, 2, 2, 1] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-350, -200]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [-180, -120, 0, 50])
...
CIV_regions = [[-100, 100]]
cont_regions = [[-350, -200], [-180, -120], [0, 50], [300, 400]]
