...
x0 = [13.5, 20.3, auto.Wave2V(1547.5, wl1)] + [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1548.6, wl1)] + [13.5, 20.3, auto.Wave2V(1549.2, wl1)] + [13.5, 20.3, auto.Wave2V(1549.8, wl1)]  + [13.2, 20.3, auto.Wave2V(1552.6, wl2)] #+ [13.4, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.2, 20.3, auto.Wave2V(1552.5, wl2)] + [13.3, 20.3, auto.Wave2V(1551.5, wl2)] + [13.2, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
#x0 = [13.5, 20.3, auto.Wave2V(1547.5, wl1)] + [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1548.6, wl1)] + [13.5, 20.3, auto.Wave2V(1549.2, wl1)] + [13.5, 20.3, auto.Wave2V(1549.8, wl2)] + [13.5, 20.3, auto.Wave2V(1552.5, wl2)] + [13.2, 20.3, auto.Wave2V(1552.6, wl2)]
feat = [0, 0, 0, 1, 0, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[150, 250]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [350, 400])
...
CIV_regions = [[-200, -100], [-100, 100], [275, 400]]
cont_regions = [[150, 250], [350, 400]]
