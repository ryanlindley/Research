...
ctn_flag = auto.mask_wl(wl, [1543, 1545.1])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548.3, wl1)] + [13.5, 20.3, auto.Wave2V(1548.6, wl1)] + [13.3, 20.3, auto.Wave2V(1547.6, wl1)] + [13.3, 20.3, auto.Wave2V(1549, wl1)] #+ [13.5, 20.3, auto.Wave2V(1549.8, wl1)]  + [13.2, 20.3, auto.Wave2V(1552.6, wl2)] #+ [13.4, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.2, 20.3, auto.Wave2V(1552.5, wl2)] + [13.3, 20.3, auto.Wave2V(1551.5, wl2)] + [13.2, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
...
strong_flag = auto.mask_v(wl, wl1,[-110, -60]) # add masking for any regions not to be used in combined data
