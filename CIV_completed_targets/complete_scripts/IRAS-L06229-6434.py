...
ctn_flag = auto.mask_wl(wl, [1548, 1551.5, 1552.3, 1553.9])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13.5, 20.3, auto.Wave2V(1548.3, wl1)] + [13.5, 20.3, auto.Wave2V(1549.6, wl2)] + [13.5, 20.3, auto.Wave2V(1550.1, wl2)] + [13.5, 20.3, auto.Wave2V(1550.4, wl2)] + [13.5, 20.3, auto.Wave2V(1551.2, wl2)] + [13.5, 20.3, auto.Wave2V(1552.5, wl2)] #+ [13.2, 20.3, auto.Wave2V(1552.5, wl2)] + [13.3, 20.3, auto.Wave2V(1551.5, wl2)] + [13.2, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 0, 2, 2, 2, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
weak_flag = auto.mask_v(wl, wl2, [-350, 0])
