...
ctn_flag = auto.mask_wl(wl, [1546, 1548.5, 1550.3, 1551])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1546.5, wl1)] + [13.5, 20.3, auto.Wave2V(1547, wl1)] + [13.5, 20.3, auto.Wave2V(1547.5, wl1)] + [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.3, 20.3, auto.Wave2V(1550.4, wl2)] + [13.3, 20.3, auto.Wave2V(1550.8, wl2)] #+ [13.2, 20.3, auto.Wave2V(1552.6, wl2)] + [13.4, 20.3, auto.Wave2V(1549.4, wl2)] #+ [13.2, 20.3, auto.Wave2V(1552.5, wl2)] + [13.3, 20.3, auto.Wave2V(1551.5, wl2)] + [13.2, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 0, 0, 0, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
CIV_regions = [[-360, -210], [-210, -90], [-90, 50]]
cont_regions = [[-100, -50]]
