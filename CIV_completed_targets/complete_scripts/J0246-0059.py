...
ctn_flag = auto.mask_wl(wl, [1547.2, 1549.5, 1550.3, 1551])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1548.4, wl1)] + [13.5, 20.3, auto.Wave2V(1548.6, wl1)] + [13.4, 20.3, auto.Wave2V(1549, wl1)] + [13.4, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1550.5, wl2)] + [13.5, 20.3, auto.Wave2V(1552.3, wl2)] #+ [13.5, 20.3, auto.Wave2V(1552.2, wl2)] + [13.5, 20.3, auto.Wave2V(1550, wl2)] + [13.5, 20.3, auto.Wave2V(1551.8, wl2)]
...
strong_flag = auto.mask_v(wl, wl1,[-30, 0, 225, 275]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [5, 40, 280, 300])
...
CIV_regions = [[-100, 90]]
cont_regions = [[-30, 0], [5, 40], [225, 275], [280, 300]]
