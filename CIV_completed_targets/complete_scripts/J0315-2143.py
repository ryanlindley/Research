...
x0 = [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1548.1, wl1)] + [13.5, 20.3, auto.Wave2V(1550.5, wl2)] + [13.3, 20.3, auto.Wave2V(1551.7, wl2)] + [13.5, 20.3, auto.Wave2V(1551.3, wl2)] + [13.5, 20.3, auto.Wave2V(1546.8, wl1)] #+ [13.5, 20.3, auto.Wave2V(1550.8, wl2)] + [13.3, 20.3, auto.Wave2V(1552.4, wl2)] #+ [13.3, 20.3, auto.Wave2V(1548.2, wl1)] #+ [13.2, 20.3, auto.Wave2V(1552.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 1, 2, 2, 2, 1] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-350, -200, -50, 0]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [100, 125, 150, 250])
...
CIV_regions = [[-90, 80]]
cont_regions = [[-350, -200], [-50, 0], [100, 125], [150, 250]]
