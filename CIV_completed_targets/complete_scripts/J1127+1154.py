...
ctn_flag = auto.mask_wl(wl,  [1546, 1546.7, 1548, 1551.2])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548.5, wl1)] + [13, 20.3, auto.Wave2V(1549.2, wl1)]+ [13.3, 20.3, auto.Wave2V(1550, wl2)] + [13.2, 20.3, auto.Wave2V(1549.5, wl1)] #+ [13, 20.3, auto.Wave2V(1552.4, wl2)] #+ [13, 20.3, auto.Wave2V(1551.67, wl2)] 
...
weak_flag = auto.mask_v(wl, wl2, [-200, -100])
