...
ctn_flag = auto.mask_wl(wl, [1550.3, 1551.6])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1547.9, wl1)] + [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13.3, 20.3, auto.Wave2V(1548.4, wl1)] + [13.3, 20.3, auto.Wave2V(1550.6, wl2)] + [13.3, 20.3, auto.Wave2V(1552.5, wl2)] #+ [13.3, 20.3, auto.Wave2V(1549.2, wl2)] + [13.3, 20.3, auto.Wave2V(1551, wl2)] + [13.3, 20.3, auto.Wave2V(1552.8, wl2)] + [13.3, 20.3, auto.Wave2V(1550.4, wl2)] #+ [13.2, 20.3, auto.Wave2V(1552.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
...
weak_flag = auto.mask_v(wl, wl2, [-50, 10, 300, 375])
