...
ctn_flag = auto.mask_wl(wl, [1546.7, 1547.4, 1547.8, 1549, 1550, 1551.8])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1547, wl1)] + [13.3, 20.3, auto.Wave2V(1548, wl1)] + [13.3, 20.3, auto.Wave2V(1548.4, wl1)] + [13.3, 20.3, auto.Wave2V(1548.8, wl1)] + [13.3, 20.3, auto.Wave2V(1550.5, wl2)] + [13.3, 20.3, auto.Wave2V(1551.7, wl2)] + [13.4, 20.3, auto.Wave2V(1547.8, wl1)] #+ [13.3, 20.3, auto.Wave2V(1552.4, wl2)] #+ [13.3, 20.3, auto.Wave2V(1548.2, wl1)] #+ [13.2, 20.3, auto.Wave2V(1552.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [1, 0, 0, 0, 2, 2, 0] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-300, -150]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [-80, -30, 100, 300])
...
CIV_regions = [[-80, 150]]
cont_regions = [[-300, -150], [-80, -30], [100, 300]]
