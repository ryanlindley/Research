...
ctn_flag = auto.mask_wl(wl, [1546, 1549.3, 1549.8, 1551.2, 1552.1, 1553.5])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548.2, wl1)]  + [13.5, 20.3, auto.Wave2V(1548.4, wl1)] + [13.5, 20.3, auto.Wave2V(1547.5, wl1)] + [13.2, 20.3, auto.Wave2V(1549.2, wl1)] + [13.5, 20.3, auto.Wave2V(1552.5, wl2)] #+ [13, 20.3, auto.Wave2V(1549.5, wl2)] #+ [13, 20.3, auto.Wave2V(1551.2, wl2)] #+ [13, 20.3, auto.Wave2V(1547.2, wl1)] + [13, 20.3, auto.Wave2V(1548.5, wl1)]
feat = [0, 1, 0, 1, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[40, 80]) # add masking for any regions not to be used in combined data
...
CIV_regions = [[-200, -125], [-50, 110]]
cont_regions = [[40, 150], [250, 400]]
