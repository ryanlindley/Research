...
x0 = [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13, 20.3, auto.Wave2V(1548, wl1)]   + [13.5, 20.3, auto.Wave2V(1549, wl1)] + [13, 20.3, auto.Wave2V(1549.8, wl2)] + [13, 20.3, auto.Wave2V(1548.2, wl1)] + [13.2, 20.3, auto.Wave2V(1547.2, wl1)] #+ [13, 20.3, auto.Wave2V(1549.6, wl2)] #+ [13, 20.3, auto.Wave2V(1551.67, wl2)] 
feat = [0, 0, 1, 2, 0, 1] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-320, -250, 150, 215]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [-250, -125])
...
CIV_regions = [[-140, 100]]
cont_regions = [[-350, -125], [-275, -125], [100, 250]]
