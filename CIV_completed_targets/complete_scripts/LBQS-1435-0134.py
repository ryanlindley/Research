...
#ctn_flag = auto.mask_wl(wl,  [1547.9, 1548.5, 1550.4, 1551.2, 1552.5, 1555])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548, wl1)]  + [13.3, 20.3, auto.Wave2V(1547.8, wl1)] + [13.3, 20.3, auto.Wave2V(1552, wl2)] + [13.5, 20.3, auto.Wave2V(1550.5, wl2)] + [13, 20.3, auto.Wave2V(1548.6, wl1)] + [13, 20.3, auto.Wave2V(1552.5, wl2)]
feat = [0, 0, 2, 2, 1, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[0, 25]) # add masking for any regions not to be used in combined data
...
CIV_regions = [[-200, 80]]
cont_regions = [[-100, 0], [200, 300], [300, 400]]
