...
ctn_flag = auto.mask_wl(wl, [1547.7, 1548.7, 1550.5, 1551])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1546.5, wl1)]  + [13.5, 20.3, auto.Wave2V(1546.8, wl1)]+ [13.3, 20.3, auto.Wave2V(1548.2, wl1)] + [13.5, 20.3, auto.Wave2V(1548.4, wl2)] + [13.5, 20.3, auto.Wave2V(1548.4, wl1)] + [13.4, 20.3, auto.Wave2V(1550, wl2)] #+ [13.3, 20.3, auto.Wave2V(1549.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1552.5, wl2)] + [13.5, 20.3, auto.Wave2V(1546.6, wl1)] #+ [13.5, 20.3, auto.Wave2V(1551.8, wl2)]
feat = [0, 0, 0, 0, 0, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
weak_flag = auto.mask_v(wl, wl2, [-500, -350, -175, -100])
...
CIV_regions = [[-400, -150], [-100, 200]]
cont_regions = [[-500, -350], [-175, -100]]
