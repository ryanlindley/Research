...
ctn_flag = auto.mask_wl(wl, [1547.7, 1548.8, 1550.5, 1551])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13.5, 20.3, auto.Wave2V(1548.5, wl1)] #+ [13.5, 20.3, auto.Wave2V(1546.4, wl1)] + [13.3, 20.3, auto.Wave2V(1548.5, wl1)] #+ [13.3, 20.3, auto.Wave2V(1547.6, wl1)] #+ [13.3, 20.3, auto.Wave2V(1550.5, wl2)] + [13.2, 20.3, auto.Wave2V(1551.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
...
strong_flag = auto.mask_v(wl, wl1,[50, 150]) # add masking for any regions not to be used in combined data
