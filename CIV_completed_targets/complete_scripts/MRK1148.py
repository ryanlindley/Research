...
x0 = [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1548.1, wl1)] + [13.5, 20.3, auto.Wave2V(1547.5, wl1)] + [13.2, 20.3, auto.Wave2V(1548.5, wl1)] #+ [13.3, 20.3, auto.Wave2V(1549.8, wl2)] + [13.3, 20.3, auto.Wave2V(1549, wl2)] + [13.3, 20.3, auto.Wave2V(1551.3, wl2)] + [13.4, 20.3, auto.Wave2V(1552, wl2)] + [13.2, 20.3, auto.Wave2V(1552.5, wl2)] #+ [13.3, 20.3, auto.Wave2V(1551.5, wl2)] + [13.2, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
...
strong_flag = auto.mask_v(wl, wl1,[50, 90]) # add masking for any regions not to be used in combined data
