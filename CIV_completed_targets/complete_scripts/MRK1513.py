...
ctn_flag = auto.mask_wl(wl, [1545.8, 1547.2])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13.5, 20.3, auto.Wave2V(1546.4, wl1)] + [13.5, 20.3, auto.Wave2V(1546.6, wl1)] + [13.2, 20.3, auto.Wave2V(1547, wl1)] + [13.3, 20.3, auto.Wave2V(1549, wl2)] + [13.2, 20.3, auto.Wave2V(1550.7, wl2)] #+ [13.3, 20.3, auto.Wave2V(1551.3, wl2)] + [13.4, 20.3, auto.Wave2V(1552, wl2)] + [13.2, 20.3, auto.Wave2V(1552.5, wl2)] #+ [13.3, 20.3, auto.Wave2V(1551.5, wl2)] + [13.2, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 0, 0, 1, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-275, -230]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [-350, -300, -50, 10])
...
CIV_regions = [[-450, -250], [-100, 100]]
cont_regions = [[-350, -300], [-275, -230], [-50, 10]]
