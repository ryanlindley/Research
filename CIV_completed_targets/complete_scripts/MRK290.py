...
ctn_flag = auto.mask_wl(wl, [1546.3, 1548.5, 1549.2, 1551])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1546.8, wl1)] + [13.5, 20.3, auto.Wave2V(1547.6, wl1)] + [13.3, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1546.5, wl1)] + [13.4, 20.3, auto.Wave2V(1548.4, wl1)] #+ [13, 20.3, auto.Wave2V(1549.2, wl2)] #+ [13.5, 20.3, auto.Wave2V(1552.4, wl2)] + [13.5, 20.3, auto.Wave2V(1551.6, wl2)] + [13.5, 20.3, auto.Wave2V(1552.5, wl2)] #+ [13.5, 20.3, auto.Wave2V(1551.8, wl2)]
...
strong_flag = auto.mask_v(wl, wl1,[-400, -325]) # add masking for any regions not to be used in combined data
