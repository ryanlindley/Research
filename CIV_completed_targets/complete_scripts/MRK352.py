...
#ctn_flag = auto.mask_wl(wl,   [1547.5, 1549.5, 1550.2, 1552])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1546.6, wl1)]  + [14, 20.3, auto.Wave2V(1547, wl1)] + [13.2, 20.3, auto.Wave2V(1548, wl1)] + [13.3, 20.3, auto.Wave2V(1548.2, wl1)] + [12.5, 20.3, auto.Wave2V(1551, wl2)] + [13, 20.3, auto.Wave2V(1550.4, wl2)] #+ [13, 20.3, auto.Wave2V(1550.5, wl2)]
...
weak_flag = auto.mask_v(wl, wl2, [-110, -80, 50, 90])
...
CIV_regions = [[-325, -175], [-100, 80]]
cont_regions = [[-110, -80], [50, 90]]
