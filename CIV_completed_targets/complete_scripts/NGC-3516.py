...
ctn_flag = auto.mask_wl(wl, [1547, 1548.5, 1550, 1550.5, 1552, 1553])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1547.9, wl1)] + [13.5, 20.3, auto.Wave2V(1548.1, wl1)] + [13.3, 20.3, auto.Wave2V(1548.4, wl1)] + [13.3, 20.3, auto.Wave2V(1547.3, wl1)] + [13.3, 20.3, auto.Wave2V(1547.5, wl1)] + [13.3, 20.3, auto.Wave2V(1549.2, wl2)] + [13.3, 20.3, auto.Wave2V(1551, wl2)] + [13.3, 20.3, auto.Wave2V(1552.8, wl2)] + [13.3, 20.3, auto.Wave2V(1550.4, wl2)] #+ [13.2, 20.3, auto.Wave2V(1552.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 0, 1, 1, 0, 2, 2, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-225, -150]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [-300, -250, -100, -50, 50, 70, 350, 500])
...
CIV_regions = [[-110, 40]]
cont_regions = [[-300, -250], [-225, -150], [-100, -50], [50, 70], [350, 500]]
