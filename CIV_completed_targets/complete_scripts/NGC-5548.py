...
x0 = [13.4, 20.3, auto.Wave2V(1546.5, wl1)] + [13.4, 20.3, auto.Wave2V(1547, wl1)] + [13.5, 20.3, auto.Wave2V(1548.1, wl1)] + [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.2, 20.3, auto.Wave2V(1548.5, wl1)] + [13.3, 20.3, auto.Wave2V(1549.8, wl2)] + [13.3, 20.3, auto.Wave2V(1549, wl2)] + [13.3, 20.3, auto.Wave2V(1551.3, wl2)] + [13.4, 20.3, auto.Wave2V(1552, wl2)] + [13.2, 20.3, auto.Wave2V(1552.5, wl2)] #+ [13.3, 20.3, auto.Wave2V(1551.5, wl2)] + [13.2, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [1, 1, 0, 0, 0, 1, 2, 2, 2, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
weak_flag = auto.mask_v(wl, wl2, [-100, 0, 350, 500])
...
auto.plot_final_data(wl, wl1, wl2, N1r, N2r, v_final, Nv_final, Nve_final, name, [-500, 500])
...
CIV_regions = [[-200, 100]]
cont_regions = [[-400, -200], [-100, 0], [350, 500]]
...
auto.save_final_data_plot(wl, wl1, wl2, N1r, N2r, v_final, Nv_final, Nve_final, name, [-500, 500])
