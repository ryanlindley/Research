...
x0 = [13.3, 20.3, auto.Wave2V(1547, wl1)] + [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13.2, 20.3, auto.Wave2V(1547.5, wl1)] + [13.2, 20.3, auto.Wave2V(1547.4, wl1)] #+ [13.3, 20.3, auto.Wave2V(1549.8, wl2)] + [13.2, 20.3, auto.Wave2V(1552.6, wl2)] + [13.4, 20.3, auto.Wave2V(1549.4, wl2)] #+ [13.2, 20.3, auto.Wave2V(1552.5, wl2)] + [13.3, 20.3, auto.Wave2V(1551.5, wl2)] + [13.2, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [1, 0, 1, 0, 0] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[0, 75]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [-325, -300])
...
CIV_regions = [[-300, -175], [-170, 50]]
cont_regions = [[-325, -300], [0, 75]]
