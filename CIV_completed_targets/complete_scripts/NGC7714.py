...
ctn_flag = auto.mask_wl(wl, [1544.5, 1545, 1546, 1547, 1548, 1549.5])  # add custom ctn if needed 
...
x0 = [13.2, 20.3, auto.Wave2V(1546.4, wl1)] + [13.5, 20.3, auto.Wave2V(1546.8, wl1)] + [13.3, 20.3, auto.Wave2V(1547.9, wl1)] + [13.5, 20.3, auto.Wave2V(1548.3, wl1)] + [13.2, 20.3, auto.Wave2V(1549.4, wl1)] + [13, 20.3, auto.Wave2V(1552.5, wl2)] #+ [13, 20.3, auto.Wave2V(1548.5, wl1)]
feat = [1, 1, 1, 0, 1, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
