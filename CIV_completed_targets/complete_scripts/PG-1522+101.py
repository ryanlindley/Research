...
ctn_flag = auto.mask_wl(wl, [1544.2, 1545.2, 1545.8, 1548.3, 1549.5, 1552])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1546, wl1)] + [13.5, 20.3, auto.Wave2V(1546.6, wl1)] + [13.5, 20.3, auto.Wave2V(1547.4, wl1)] + [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1551, wl2)] + [13.5, 20.3, auto.Wave2V(1551.6, wl2)] + [13.4, 20.3, auto.Wave2V(1550.4, wl2)] #+ [13.3, 20.3, auto.Wave2V(1552.4, wl2)] #+ [13.3, 20.3, auto.Wave2V(1548.2, wl1)] #+ [13.2, 20.3, auto.Wave2V(1552.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [1, 1, 0, 0, 2, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-500, -400, -375, -275]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [-200, -10, 10, 275])
...
auto.plot_final_data(wl, wl1, wl2, N1r, N2r, v_final, Nv_final, Nve_final, name, [-500, 400])
...
CIV_regions = [[-220, 50]]
cont_regions = [[-500, -400], [-375, -275], [-200, -10], [10, 275]]
...
auto.save_final_data_plot(wl, wl1, wl2, N1r, N2r, v_final, Nv_final, Nve_final, name, [-500, 400])
