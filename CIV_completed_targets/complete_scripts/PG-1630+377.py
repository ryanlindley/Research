...
x0 =[13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1548.5, wl1)] + [13.5, 20.3, auto.Wave2V(1550, wl2)] + [13.5, 20.3, auto.Wave2V(1552.8, wl2)] + [13.5, 20.3, auto.Wave2V(1547.5, wl1)] #+ [13.5, 20.3, auto.Wave2V(1552.5, wl2)] + [13.5, 20.3, auto.Wave2V(1550.7, wl2)] + [13.5, 20.3, auto.Wave2V(1548.6, wl1)]
feat = [0, 1, 2, 2, 1] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-200, 200]) # add masking for any regions not to be used in combined data
