...
ctn_flag = auto.mask_wl(wl,  [1546, 1547, 1547.6, 1549.3, 1550.2, 1551.3])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13, 20.3, auto.Wave2V(1548.2, wl1)] +  [13.5, 20.3, auto.Wave2V(1546.4, wl1)] + [13, 20.3, auto.Wave2V(1547, wl1)] + [13.2, 20.3, auto.Wave2V(1546.4, wl1)] + [13, 20.3, auto.Wave2V(1552.4, wl2)] #+ [13, 20.3, auto.Wave2V(1551.67, wl2)] 
...
CIV_regions = [[-500, -200], [-150, 100]]
cont_regions = [[350, 475]]
