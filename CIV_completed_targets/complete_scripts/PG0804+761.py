...
ctn_flag = auto.mask_wl(wl, [1543, 1545.3, 1547.4, 1548.5])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1547.9, wl1)] + [13.5, 20.3, auto.Wave2V(1547.5, wl1)] + [13.5, 20.3, auto.Wave2V(1550.3, wl2)] #+ [13.5, 20.3, auto.Wave2V(1550.1, wl2)] + [13.5, 20.3, auto.Wave2V(1550.4, wl2)] + [13.5, 20.3, auto.Wave2V(1551.2, wl2)] + [13.5, 20.3, auto.Wave2V(1552.5, wl2)] #+ [13.2, 20.3, auto.Wave2V(1552.5, wl2)] + [13.3, 20.3, auto.Wave2V(1551.5, wl2)] + [13.2, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
...
weak_flag = auto.mask_v(wl, wl2, [-175, -75])
