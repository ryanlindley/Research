...
ctn_flag = auto.mask_wl(wl, [1546.6, 1549, 1550.2, 1551.2])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.6, 20.3, auto.Wave2V(1548.2, wl1)] + [13.3, 20.3, auto.Wave2V(1548.8, wl1)] + [13.2, 20.3, auto.Wave2V(1549.5, wl1)] + [13, 20.3, auto.Wave2V(1550.8, wl2)] + [13, 20.3, auto.Wave2V(1551.6, wl2)] #+ [13, 20.3, auto.Wave2V(1548.7, wl1)]
...
strong_flag = auto.mask_v(wl, wl1,[201, 250]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [-25, 0, 150, 200])
...
CIV_regions = [[-200, 200]]
cont_regions = [[-25, 0], [150, 200], [200, 250]]
