...
ctn_flag = auto.mask_wl(wl, [1547.8, 1552.4])  # add custom ctn if needed 
...
x0 =[13.3, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1548.5, wl1)]   + [13.5, 20.3, auto.Wave2V(1548.7, wl1)] + [13, 20.3, auto.Wave2V(1549.7, wl1)] + [13.4, 20.3, auto.Wave2V(1551.3, wl2)] #+ [13.3, 20.3, auto.Wave2V(1552.5, wl2)]
...
weak_flag = auto.mask_v(wl, wl2, [50, 150])
