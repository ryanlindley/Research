...
ctn_flag = auto.mask_wl(wl, [1547.4, 1549.9, 1550.6, 1551.5, 1553.3, 1555])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1547.7, wl1)] + [13.5, 20.3, auto.Wave2V(1548.3, wl1)] + [13.5, 20.3, auto.Wave2V(1549.2, wl1)] + [13.4, 20.3, auto.Wave2V(1548.8, wl1)] + [13.4, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1552.5, wl2)] + [13.5, 20.3, auto.Wave2V(1548.5, wl1)] + [13.5, 20.3, auto.Wave2V(1551.3, wl2)] #+ [13.5, 20.3, auto.Wave2V(1550, wl2)] + [13.5, 20.3, auto.Wave2V(1551.8, wl2)]
feat = [0, 0, 0, 1, 1, 2, 1, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
CIV_regions = [[-150, -50], [-45, 275]]
cont_regions = [[-200, -50], [0, 50], [50, 100], [350, 400]]
