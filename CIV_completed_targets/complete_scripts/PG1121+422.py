...
x0 = [13.5, 20.3, auto.Wave2V(1548, wl1)]  + [13.5, 20.3, auto.Wave2V(1548.4, wl1)] + [13.2, 20.3, auto.Wave2V(1548.6, wl1)] + [13.3, 20.3, auto.Wave2V(1552.5, wl2)] #+ [13, 20.3, auto.Wave2V(1547.5, wl1)] + [13, 20.3, auto.Wave2V(1548, wl1)] + [13, 20.3, auto.Wave2V(1550.5, wl2)]
...
strong_flag = auto.mask_v(wl, wl1,[25, 50]) # add masking for any regions not to be used in combined data
