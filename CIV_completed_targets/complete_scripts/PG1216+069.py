...
ctn_flag = auto.mask_wl(wl, [1546, 1549.8, 1550.5, 1551])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1547, wl1)] + [13.2, 20.3, auto.Wave2V(1548.2, wl1)] + [13.5, 20.3, auto.Wave2V(1548.1, wl1)] + [13.2, 20.3, auto.Wave2V(1549.2, wl2)] + [13.4, 20.3, auto.Wave2V(1549.5, wl2)] + [13.2, 20.3, auto.Wave2V(1552, wl2)] #+ [13, 20.3, auto.Wave2V(1547.2, wl1)] + [13, 20.3, auto.Wave2V(1548.5, wl1)]
feat = [1, 0, 1, 2, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-240, -150, -100, 110]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [-350, -241])
...
CIV_regions = [[-75, 50]]
cont_regions = [[-350, -200], [-300, -150], [-100, 110]]
