...
x0 = [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13.5, 20.3, auto.Wave2V(1548.3, wl1)] + [13.5, 20.3, auto.Wave2V(1548.1, wl1)] + [13.3, 20.3, auto.Wave2V(1548.6, wl1)] + [13.4, 20.3, auto.Wave2V(1551, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.5, wl1)] + [13.5, 20.3, auto.Wave2V(1550, wl2)] + [13.5, 20.3, auto.Wave2V(1551.4, wl2)] + [13.5, 20.3, auto.Wave2V(1549.2, wl1)] #+ [13.5, 20.3, auto.Wave2V(1551.8, wl2)]
feat = [0, 0, 0, 0, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
weak_flag = auto.mask_v(wl, wl2, [20, 50])
