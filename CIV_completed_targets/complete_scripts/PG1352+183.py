...
x0 = [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.3, 20.3, auto.Wave2V(1548.5, wl1)] + [13.5, 20.3, auto.Wave2V(1550.5, wl2)] + [13.5, 20.3, auto.Wave2V(1548, wl1)] #+ [13.3, 20.3, auto.Wave2V(1550.4, wl2)] + [13.3, 20.3, auto.Wave2V(1550.8, wl2)] #+ [13.2, 20.3, auto.Wave2V(1552.6, wl2)] + [13.4, 20.3, auto.Wave2V(1549.4, wl2)] #+ [13.2, 20.3, auto.Wave2V(1552.5, wl2)] + [13.3, 20.3, auto.Wave2V(1551.5, wl2)] + [13.2, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 1, 2, 0] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-40, -20, 60, 110]) # add masking for any regions not to be used in combined data
...
CIV_regions = [[-140, 50]]
cont_regions = [[-100, -60], [-40, -20], [60, 110]]
