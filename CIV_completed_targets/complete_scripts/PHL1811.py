...
ctn_flag = auto.mask_wl(wl, [1546, 1551.5])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1546.2, wl1)] + [13.5, 20.3, auto.Wave2V(1546.6, wl1)] + [13.5, 20.3, auto.Wave2V(1547, wl1)] + [13.5, 20.3, auto.Wave2V(1547.4, wl1)] + [13, 20.3, auto.Wave2V(1548.2, wl1)] + [13.2, 20.3, auto.Wave2V(1548.6, wl1)] + [13, 20.3, auto.Wave2V(1547.6, wl1)] #+ [13.3, 20.3, auto.Wave2V(1551.5, wl2)] + [13.2, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 0, 0, 0, 0, 0, 0] #which features used to model 0 - both, 1 - strong, 2 - weak
