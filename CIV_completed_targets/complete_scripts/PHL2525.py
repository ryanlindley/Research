...
ctn_flag = auto.mask_wl(wl, [1547, 1548.8, 1549.5, 1551])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13.5, 20.3, auto.Wave2V(1547, wl1)] + [13.5, 20.3, auto.Wave2V(1547.6, wl1)] + [13.2, 20.3, auto.Wave2V(1550.2, wl2)] #+ [13.3, 20.3, auto.Wave2V(1549, wl2)] + [13.2, 20.3, auto.Wave2V(1550.7, wl2)] #+ [13.3, 20.3, auto.Wave2V(1551.3, wl2)] + [13.4, 20.3, auto.Wave2V(1552, wl2)] + [13.2, 20.3, auto.Wave2V(1552.5, wl2)] #+ [13.3, 20.3, auto.Wave2V(1551.5, wl2)] + [13.2, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
...
weak_flag = auto.mask_v(wl, wl2, [-125, -40])
