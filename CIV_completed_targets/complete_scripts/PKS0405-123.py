...
x0 = [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13.5, 20.3, auto.Wave2V(1551.4, wl2)] + [13, 20.3, auto.Wave2V(1550.4, wl2)] + [13, 20.3, auto.Wave2V(1548.8, wl1)] + [13.2, 20.3, auto.Wave2V(1551.6, wl2)] + [13, 20.3, auto.Wave2V(1552.3, wl2)] #+ [13.3, 20.3, auto.Wave2V(1551.5, wl2)] + [13.2, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 1, 2, 2, 1, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-65, 30]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [40, 200, 260, 300])
...
CIV_regions = [[-125, 60]]
cont_regions = [[-65, 30], [40, 200], [260, 300]]
