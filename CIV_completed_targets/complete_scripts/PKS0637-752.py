...
ctn_flag = auto.mask_wl(wl, [1545, 1545.3, 1547.1, 1547.5, 1548, 1548.8, 1549.2, 1550.3, 1550.7, 1551.5, 1552.3, 1553])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1547.4, wl1)] + [13.4, 20.3, auto.Wave2V(1548, wl1)] + [13.4, 20.3, auto.Wave2V(1548.5, wl1)] + [13.5, 20.3, auto.Wave2V(1548.7, wl1)] + [13.5, 20.3, auto.Wave2V(1549.8, wl1)] + [13.5, 20.3, auto.Wave2V(1550, wl1)] + [13.3, 20.3, auto.Wave2V(1552.8, wl2)] #+ [13.3, 20.3, auto.Wave2V(1550.5, wl2)] + [13.2, 20.3, auto.Wave2V(1551.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [1, 0, 0, 0, 1, 1, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-220, -120, 175, 275]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [300, 500])
...
auto.plot_final_data(wl, wl1, wl2, N1r, N2r, v_final, Nv_final, Nve_final, name, [-300, 500])
...
CIV_regions = [[-50, 160]]
cont_regions = [[-220, -120], [175, 275], [300, 500]]
...
auto.save_final_data_plot(wl, wl1, wl2, N1r, N2r, v_final, Nv_final, Nve_final, name, [-300, 500])
