...
ctn_flag = auto.mask_wl(wl, [1548, 1549, 1550.5,  1551.5, 1552.5, 1553, 1553.5, 1555])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548, wl1)]  + [13.5, 20.3, auto.Wave2V(1548.6, wl1)] + [13.2, 20.3, auto.Wave2V(1550, wl2)] + [13.2, 20.3, auto.Wave2V(1552.8, wl2)] #+ [13.5, 20.3, auto.Wave2V(1552.5, wl2)] #+ [13, 20.3, auto.Wave2V(1549.5, wl2)] #+ [13, 20.3, auto.Wave2V(1551.2, wl2)] #+ [13, 20.3, auto.Wave2V(1547.2, wl1)] + [13, 20.3, auto.Wave2V(1548.5, wl1)]
...
weak_flag = auto.mask_v(wl, wl2, [-150, -100, 350, 450])
