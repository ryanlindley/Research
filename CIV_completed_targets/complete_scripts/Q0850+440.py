...
ctn_flag = auto.mask_wl(wl, [1547, 1551, 1552.5, 1553])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1547.8, wl1)] + [13.5, 20.3, auto.Wave2V(1548.3, wl1)] + [13.5, 20.3, auto.Wave2V(1549.3, wl2)] + [13.5, 20.3, auto.Wave2V(1549.4, wl2)] +[13.5, 20.3, auto.Wave2V(1550.2, wl2)] #+ [13.5, 20.3, auto.Wave2V(1553, wl2)] #+ [13.2, 20.3, auto.Wave2V(1552.5, wl2)] + [13.3, 20.3, auto.Wave2V(1551.5, wl2)] + [13.2, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 0, 2, 2, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
p0, cov, a, b, c = auto.leastsq(auto.fitting, x0, full_output=1, args=(feat, wl, wl1, wl2, f1, f2, gamma1, gamma2, lsf, fn, fne, [1547, 1552]))
