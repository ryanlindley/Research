...
ctn_flag = auto.mask_wl(wl, [1543, 1545.8, 1547.5, 1548.6])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1548.1, wl1)] + [13.3, 20.3, auto.Wave2V(1551.2, wl2)] #+ [13.5, 20.3, auto.Wave2V(1550.5, wl2)] #+ [13.2, 20.3, auto.Wave2V(1552, wl2)] #+ [13, 20.3, auto.Wave2V(1547.2, wl1)] + [13, 20.3, auto.Wave2V(1548.5, wl1)]
...
weak_flag = auto.mask_v(wl, wl2, [50, 125])
