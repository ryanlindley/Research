...
ctn_flag = auto.mask_wl(wl,   [1546.25, 1546.6, 1547.4, 1549.1, 1550.2, 1551.4])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548.2, wl1)]  + [13.5, 20.3, auto.Wave2V(1548.6, wl1)] + [13.2, 20.3, auto.Wave2V(1547.5, wl1)] + [13, 20.3, auto.Wave2V(1548.9, wl1)] + [13, 20.3, auto.Wave2V(1547.7, wl1)]
feat = [0, 0, 1, 1, 0] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-150, -100, 125, 175]) # add masking for any regions not to be used in combined data
