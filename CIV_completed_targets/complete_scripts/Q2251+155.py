...
ctn_flag = auto.mask_wl(wl, [1546, 1547.4, 1547.8, 1549, 1550, 1551])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1546.2, wl1)]  + [13.5, 20.3, auto.Wave2V(1546.5, wl1)] + [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13, 20.3, auto.Wave2V(1548.3, wl1)] + [12.8, 20.3, auto.Wave2V(1547, wl1)] + [13, 20.3, auto.Wave2V(1548.1, wl1)] #+ [13, 20.3, auto.Wave2V(1550, wl2)] + [13, 20.3, auto.Wave2V(1550.2, wl2)] + [13, 20.3, auto.Wave2V(1547.2, wl1)] + [13, 20.3, auto.Wave2V(1548.5, wl1)]
feat = [0, 0, 0, 0, 1, 1] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-350, -250, -50, 50]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [])
...
CIV_regions = [[-400, -275], [-50, 100]]
cont_regions = [[-350, -250], [-50, 50]]
