...
ctn_flag = auto.mask_wl(wl, [1547.5, 1549, 1550, 1551.2])  # add custom ctn if needed 
...
x0 =[13.5, 20.3, auto.Wave2V(1547.5, wl1)] + [13.3, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1548.6, wl1)] + [13.5, 20.3, auto.Wave2V(1548.3, wl1)] + [13.3, 20.3, auto.Wave2V(1551, wl2)] + [13, 20.3, auto.Wave2V(1551.5, wl2)] + [13, 20.3, auto.Wave2V(1547.8, wl1)] + [13.3, 20.3, auto.Wave2V(1552.5, wl2)]
feat = [0, 0, 1, 0, 2, 2, 1, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
CIV_regions = [[-150, 20]]
cont_regions = [[50, 110], [0, 60], [150, 200], [300, 375]]
