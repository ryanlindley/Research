...
ctn_flag = auto.mask_wl(wl, [1547.5, 1548.7, 1550, 1551])  # add custom ctn if needed 
...
x0 = [13.2, 20.3, auto.Wave2V(1547.2, wl1)] + [13.5, 20.3, auto.Wave2V(1547.7, wl1)] + [13.4, 20.3, auto.Wave2V(1548, wl1)] + [13.3, 20.3, auto.Wave2V(1548.6, wl1)] + [13.5, 20.3, auto.Wave2V(1550.3, wl2)] + [13.5, 20.3, auto.Wave2V(1549.5, wl2)] + [13.3, 20.3, auto.Wave2V(1549.8, wl2)] + [13.3, 20.3, auto.Wave2V(1552, wl2)] + [13.2, 20.3, auto.Wave2V(1552.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [1, 1, 0, 1, 2, 2, 2, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-100, -80, 50, 100]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [-325, -275, 225, 300, 350, 400])
...
auto.plot_final_data(wl, wl1, wl2, N1r, N2r, v_final, Nv_final, Nve_final, name, [-400, 500])
...
CIV_regions = [[-150, 50]]
cont_regions = [[-325, -275], [-100, -80], [50, 100], [225, 300], [350, 400]]
...
auto.save_final_data_plot(wl, wl1, wl2, N1r, N2r, v_final, Nv_final, Nve_final, name, [-400, 500])
