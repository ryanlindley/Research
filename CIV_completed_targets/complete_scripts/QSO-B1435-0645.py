...
ctn_flag = auto.mask_wl(wl, [1547, 1549, 1549.5, 1550.5])  # add custom ctn if needed 
...
check_larger_continuum(name, wl, new_ctn)
...
x0 = [13.2, 20.3, auto.Wave2V(1547.2, wl1)] + [13.5, 20.3, auto.Wave2V(1547.5, wl1)] + [13.3, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1548.5, wl1)] + [13.2, 20.3, auto.Wave2V(1551.2, wl2)] #+ [13, 20.3, auto.Wave2V(1547.2, wl1)] + [13, 20.3, auto.Wave2V(1548.5, wl1)]
feat = [1, 0, 0, 1, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-200, -180]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [40, 100])
