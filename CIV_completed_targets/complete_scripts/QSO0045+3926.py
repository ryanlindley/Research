...
ctn_flag = auto.mask_wl(wl, [1546, 1551, 1553, 1555])  # add custom ctn if needed 
...
x0 = [14, 20.3, auto.Wave2V(1547, wl1)]  + [14, 20.3, auto.Wave2V(1547.2, wl1)] + [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13, 20.3, auto.Wave2V(1546.4, wl1)] + [13.5, 20.3, auto.Wave2V(1550.8, wl2)] + [13, 20.3, auto.Wave2V(1552.5, wl2)]  + [13, 20.3, auto.Wave2V(1551.2, wl2)] #+ [13, 20.3, auto.Wave2V(1547.2, wl1)] + [13, 20.3, auto.Wave2V(1548.5, wl1)]
feat = [0, 0, 0, 0, 2, 2, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
CIV_regions = [[-450, -300], [-300, -110], [-110, 80]]
cont_regions = [[-125, 100]]
