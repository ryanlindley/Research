...
ctn_flag = auto.mask_wl(wl, [1547, 1550, 1550.5, 1553])  # add custom ctn if needed 
...
x0 =[13.5, 20.3, auto.Wave2V(1548.5, wl1)] + [13.3, 20.3, auto.Wave2V(1549.5, wl1)] + [13.5, 20.3, auto.Wave2V(1552.7, wl2)] #+ [13.5, 20.3, auto.Wave2V(1551, wl2)] #+ [13, 20.3, auto.Wave2V(1552.5, wl2)] #+ [13, 20.3, auto.Wave2V(1548.5, wl1)]
...
CIV_regions = [[-80, 175], [175, 275]]
cont_regions = [[350, 400]]
