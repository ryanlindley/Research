...
ctn_flag = auto.mask_wl(wl, [1543, 1544.3, 1547.5, 1548.7, 1550.1, 1551.2])  # add custom ctn if needed 
...
x0 =[13.5, 20.3, auto.Wave2V(1547.8, wl1)] + [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13.5, 20.3, auto.Wave2V(1548.4, wl1)] + [13.2, 20.3, auto.Wave2V(1550.5, wl2)] + [13.4, 20.3, auto.Wave2V(1552.5, wl2)] + [13.3, 20.3, auto.Wave2V(1548.3, wl1)]
feat = [0, 0, 0, 2, 2, 1] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[20, 50]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [-80, -20, 320, 400])
...
CIV_regions = [[-140, 120]]
cont_regions = [[-80, -20], [20, 50], [320, 400]]
