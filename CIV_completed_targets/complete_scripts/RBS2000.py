...
ctn_flag = auto.mask_wl(wl, [1547, 1548.8, 1549.8, 1551])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1547.5, wl1)] + [13.3, 20.3, auto.Wave2V(1547.1, wl1)] + [13.3, 20.3, auto.Wave2V(1548.5, wl1)] + [13.3, 20.3, auto.Wave2V(1548.8, wl1)] + [13.5, 20.3, auto.Wave2V(1547.7, wl1)] #+ [13.5, 20.3, auto.Wave2V(1550.8, wl2)] + [13.3, 20.3, auto.Wave2V(1552.4, wl2)] #+ [13.3, 20.3, auto.Wave2V(1548.2, wl1)] #+ [13.2, 20.3, auto.Wave2V(1552.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 0, 0, 0, 0, 0] #which features used to model 0 - both, 1 - strong, 2 - weak
