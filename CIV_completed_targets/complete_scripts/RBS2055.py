...
ctn_flag = auto.mask_wl(wl, [1544.3, 1544.4, 1545.7, 1546.8, 1547.5, 1549.5, 1550.5, 1551, 1553.3, 1553.8])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13.5, 20.3, auto.Wave2V(1549.8, wl2)] + [13.5, 20.3, auto.Wave2V(1546.4, wl1)] + [13.3, 20.3, auto.Wave2V(1548.5, wl1)] #+ [13.3, 20.3, auto.Wave2V(1547.6, wl1)] #+ [13.3, 20.3, auto.Wave2V(1550.5, wl2)] + [13.2, 20.3, auto.Wave2V(1551.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 0, 2, 0, 1] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[40, 100]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [-200, -150])
...
auto.plot_final_data(wl, wl1, wl2, N1r, N2r, v_final, Nv_final, Nve_final, name, [-500, 300])
...
CIV_regions = [[-475, -250], [-125, 50]]
cont_regions = [[-200, -150], [40, 100]]
...
auto.save_final_data_plot(wl, wl1, wl2, N1r, N2r, v_final, Nv_final, Nve_final, name, [-500, 300])
