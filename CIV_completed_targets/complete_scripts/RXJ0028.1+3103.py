...
ctn_flag = auto.mask_wl(wl, [1545.5, 1547, 1547.7, 1548.5, 1550, 1551, 1552.3, 1555])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1547.1, wl1)] + [13.5, 20.3, auto.Wave2V(1547.8, wl1)] + [13.3, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1552.2, wl2)] + [13.5, 20.3, auto.Wave2V(1553, wl2)] + [13.3, 20.3, auto.Wave2V(1548.7, wl1)] + [13.3, 20.3, auto.Wave2V(1549.8, wl2)] + [13.5, 20.3, auto.Wave2V(1550.6, wl2)] + [13.5, 20.3, auto.Wave2V(1551.5, wl2)] #+ [13.5, 20.3, auto.Wave2V(1551.8, wl2)]
feat = [1, 0, 0, 2, 2, 1, 2, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
