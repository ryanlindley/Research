...
ctn_flag = auto.mask_wl(wl, [1547.8, 1548.9, 1549.6, 1551.5, 1552.5, 1553])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13.5, 20.3, auto.Wave2V(1548.8, wl1)] + [13.3, 20.3, auto.Wave2V(1550.5, wl2)] + [13.3, 20.3, auto.Wave2V(1549.9, wl2)] + [13.2, 20.3, auto.Wave2V(1552.5, wl2)] #+ [13, 20.3, auto.Wave2V(1547.2, wl1)] + [13, 20.3, auto.Wave2V(1548.5, wl1)]
feat = [0, 0, 2, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
weak_flag = auto.mask_v(wl, wl2, [-200, 0, 300, 400])
