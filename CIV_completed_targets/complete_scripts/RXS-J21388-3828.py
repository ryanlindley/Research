...
ctn_flag = auto.mask_wl(wl, [1547.1, 1549, 1550, 1551.3])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1547.4, wl1)] + [13.5, 20.3, auto.Wave2V(1548.4, wl1)] + [13.5, 20.3, auto.Wave2V(1548, wl1)]  + [13.3, 20.3, auto.Wave2V(1549.5, wl2)] + [13.3, 20.3, auto.Wave2V(1547.8, wl1)] #+ [13.3, 20.3, auto.Wave2V(1546.4, wl1)] #+ [13.4, 20.3, auto.Wave2V(1552, wl2)] + [13.2, 20.3, auto.Wave2V(1552.5, wl2)] #+ [13.3, 20.3, auto.Wave2V(1551.5, wl2)] + [13.2, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 0, 0, 2, 0] #which features used to model 0 - both, 1 - strong, 2 - weak
...
weak_flag = auto.mask_v(wl, wl2, [-250, -200])
