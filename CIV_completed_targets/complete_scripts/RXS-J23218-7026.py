...
ctn_flag = auto.mask_wl(wl, [1547.5, 1549.5, 1550.7, 1552])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13.2, 20.3, auto.Wave2V(1549, wl1)] + [13.5, 20.3, auto.Wave2V(1549.2, wl1)] + [13.5, 20.3, auto.Wave2V(1551, wl2)] + [13.5, 20.3, auto.Wave2V(1551.2, wl2)] + [13.2, 20.3, auto.Wave2V(1552, wl2)] + [13.2, 20.3, auto.Wave2V(1550.5, wl2)] #+ [13.4, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.2, 20.3, auto.Wave2V(1552.5, wl2)] + [13.3, 20.3, auto.Wave2V(1551.5, wl2)] + [13.2, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 1, 1, 2, 2, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
weak_flag = auto.mask_v(wl, wl2, [-100, 200])
