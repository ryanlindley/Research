...
ctn_flag = auto.mask_wl(wl, [1546.8, 1547, 1547.75, 1548.4, 1549.4, 1551, 1552.5, 1555])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1547, wl1)] + [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.3, 20.3, auto.Wave2V(1548.2, wl1)]  + [13.3, 20.3, auto.Wave2V(1552.6, wl2)] #+ [13, 20.3, auto.Wave2V(1550, wl2)] #+ [13.3, 20.3, auto.Wave2V(1551, wl2)] + [13.3, 20.3, auto.Wave2V(1552.8, wl2)] + [13.3, 20.3, auto.Wave2V(1550.4, wl2)] #+ [13.2, 20.3, auto.Wave2V(1552.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 0, 0, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
weak_flag = auto.mask_v(wl, wl2, [300, 400])
...
CIV_regions = [[-275, -150], [-100, 50]]
cont_regions = [[300, 400]]
