...
ctn_flag = auto.mask_wl(wl, [1546.3, 1548.2, 1550.2, 1551.1])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.6, 20.3, auto.Wave2V(1550.6, wl2)] + [13.3, 20.3, auto.Wave2V(1547, wl1)] + [13.2, 20.3, auto.Wave2V(1551.2, wl2)] #+ [13, 20.3, auto.Wave2V(1547.2, wl1)] #+ [13, 20.3, auto.Wave2V(1551.2, wl2)] + [13, 20.3, auto.Wave2V(1548.7, wl1)]
feat = [0, 2, 0, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
weak_flag = auto.mask_v(wl, wl2, [-75, 0, 25, 50])
