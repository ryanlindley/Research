...
ctn_flag = auto.mask_wl(wl, [1547.1, 1548.5, 1549.2, 1551])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1547.6, wl1)] + [13.5, 20.3, auto.Wave2V(1547.8, wl1)] + [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.4, 20.3, auto.Wave2V(1547.2, wl1)] + [13.4, 20.3, auto.Wave2V(1549.3, wl2)] + [13.5, 20.3, auto.Wave2V(1550.5, wl2)] + [13.5, 20.3, auto.Wave2V(1552.5, wl2)] + [13.5, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1550, wl2)] + [13.5, 20.3, auto.Wave2V(1551.8, wl2)]
feat = [0, 0, 0, 1, 2, 2, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
weak_flag = auto.mask_v(wl, wl2, [-275, -200, -110, 50, 300, 425])
...
CIV_regions = [[-225, 100]]
cont_regions = [[-275, -200], [-110, 50], [300, 425]]
