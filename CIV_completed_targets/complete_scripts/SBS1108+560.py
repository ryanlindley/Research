...
ctn_flag = auto.mask_wl(wl, [1544.5, 1545, 1547.5, 1548.5, 1550, 1552.5, 1553, 1555])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1547.2, wl1)] + [13.5, 20.3, auto.Wave2V(1547.7, wl1)] + [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.3, 20.3, auto.Wave2V(1548.3, wl1)] + [13.4, 20.3, auto.Wave2V(1551, wl2)] + [13.5, 20.3, auto.Wave2V(1551.8, wl2)] + [13.5, 20.3, auto.Wave2V(1552.4, wl2)] + [13.5, 20.3, auto.Wave2V(1551.6, wl2)] + [13.5, 20.3, auto.Wave2V(1552.5, wl2)] #+ [13.5, 20.3, auto.Wave2V(1551.8, wl2)]
feat = [0, 0, 0, 0, 2, 2, 2, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
weak_flag = auto.mask_v(wl, wl2, [-150, 350])
