...
ctn_flag = auto.mask_wl(wl, [1543, 1544.4, 1545, 1546.4, 1547.4, 1548.4, 1549.2, 1551, 1553, 1553.6, 1554, 1555])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1547.5, wl1)]  + [13.5, 20.3, auto.Wave2V(1548, wl1)]+ [13.3, 20.3, auto.Wave2V(1549.3, wl1)] + [13.5, 20.3, auto.Wave2V(1551.5, wl2)] + [13.5, 20.3, auto.Wave2V(1553, wl2)] #+ [13.4, 20.3, auto.Wave2V(1550, wl2)] #+ [13.3, 20.3, auto.Wave2V(1549.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1552.5, wl2)] + [13.5, 20.3, auto.Wave2V(1546.6, wl1)] #+ [13.5, 20.3, auto.Wave2V(1551.8, wl2)]
feat = [0, 0, 1, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[175, 275]) # add masking for any regions not to be used in combined data
