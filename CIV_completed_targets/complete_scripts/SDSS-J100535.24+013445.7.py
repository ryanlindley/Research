...
ctn_flag = auto.mask_wl(wl, [1543, 1544.1, 1547.3, 1547.7, 1548, 1549, 1550.5, 1551.5, 1552.2, 1552.8])  # add custom ctn if needed 
...
strong_flag = auto.mask_v(wl, wl1,[-200, -100, 60, 110]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [250, 400])
...
CIV_regions = [[-50, 200]]
cont_regions = [[-200, -100], [60, 110], [250, 400]]
