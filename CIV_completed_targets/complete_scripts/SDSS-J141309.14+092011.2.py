...
ctn_flag = auto.mask_wl(wl, [1543, 1545.7])  # add custom ctn if needed 
...
strong_flag = auto.mask_v(wl, wl1,[250, 275]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [125, 200])
