...
ctn_flag = auto.mask_wl(wl, [1545.6, 1546.8, 1547.2, 1549, 1549.5, 1551.5, 1552.5, 1555])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1547.8, wl1)] + [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.3, 20.3, auto.Wave2V(1548.6, wl1)] + [13.3, 20.3, auto.Wave2V(1551.2, wl2)] + [13.3, 20.3, auto.Wave2V(1549.8, wl2)] + [13.2, 20.3, auto.Wave2V(1552.6, wl2)] + [13.4, 20.3, auto.Wave2V(1549.4, wl2)] #+ [13.2, 20.3, auto.Wave2V(1552.5, wl2)] + [13.3, 20.3, auto.Wave2V(1551.5, wl2)] + [13.2, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 0, 0, 2, 2, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
weak_flag = auto.mask_v(wl, wl2, [-250, -100, 0, 50, 350, 400])
...
CIV_regions = [[-125, 100]]
cont_regions = [[-250, -100], [0, 50], [350, 400]]
