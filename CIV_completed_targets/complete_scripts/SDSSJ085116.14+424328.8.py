...
ctn_flag = auto.mask_wl(wl, [1547, 1548.8, 1550, 1551.3])  # add custom ctn if needed 
...
x0 = [13, 20.3, auto.Wave2V(1547.8, wl1)] + [13.3, 20.3, auto.Wave2V(1548, wl1)]+ [13.3, 20.3, auto.Wave2V(1548.3, wl1)] + [13, 20.3, auto.Wave2V(1548.5, wl1)] + [13, 20.3, auto.Wave2V(1547.2, wl1)] #+ [13, 20.3, auto.Wave2V(1551.2, wl2)] + [13, 20.3, auto.Wave2V(1548.7, wl1)]
feat = [0, 0, 1, 0, 1] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-100, -50, -25, 0]) # add masking for any regions not to be used in combined data
