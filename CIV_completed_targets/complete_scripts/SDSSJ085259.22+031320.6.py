...
ctn_flag = auto.mask_wl(wl, [1547.8, 1549, 1550.5, 1551.2])  # add custom ctn if needed 
...
x0 = [13.3, 20.3, auto.Wave2V(1548, wl1)] + [13.6, 20.3, auto.Wave2V(1548.2, wl1)] + [13.3, 20.3, auto.Wave2V(1548.6, wl1)] + [13.2, 20.3, auto.Wave2V(1549.2, wl1)] + [13, 20.3, auto.Wave2V(1547.6, wl1)] + [13, 20.3, auto.Wave2V(1551, wl2)] #+ [13, 20.3, auto.Wave2V(1548.7, wl1)]
...
weak_flag = auto.mask_v(wl, wl2, [75, 125])
...
CIV_regions = [[-140, -80], [-80, 100], [180, 200]]
cont_regions = [[75, 125]]
