...
ctn_flag = auto.mask_wl(wl, [1547.5, 1549.5, 1550.1, 1550.8])  # add custom ctn if needed 
...
x0 =[13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1549.2, wl1)] + [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13, 20.3, auto.Wave2V(1551.2, wl2)] #+ [13.2, 20.3, auto.Wave2V(1552.5, wl2)] + [13.3, 20.3, auto.Wave2V(1551.5, wl2)] + [13.2, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
...
CIV_regions = [[-120, 50], [175, 225]]
cont_regions = [[-50, 100], [55, 100]]
