...
x0 = [13.5, 20.3, auto.Wave2V(1547.8, wl1)] + [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1549.2, wl1)] + [13.3, 20.3, auto.Wave2V(1551, wl2)] + [13.5, 20.3, auto.Wave2V(1548.3, wl1)] #+ [13, 20.3, auto.Wave2V(1549.2, wl1)] #+ [13.3, 20.3, auto.Wave2V(1552.8, wl2)] + [13.3, 20.3, auto.Wave2V(1548.2, wl1)] #+ [13.2, 20.3, auto.Wave2V(1552.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 0, 1, 2, 0] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[160, 240]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [0, 75])
