...
ctn_flag = auto.mask_wl(wl, [1547.5, 1549.4, 1550, 1552.8])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1548.4, wl1)] + [13.5, 20.3, auto.Wave2V(1549, wl1)] + [13.5, 20.3, auto.Wave2V(1550.7, wl2)] + [13.5, 20.3, auto.Wave2V(1551, wl2)] + [13.5, 20.3, auto.Wave2V(1551.5, wl2)] + [13.5, 20.3, auto.Wave2V(1552.8, wl2)] + [13.5, 20.3, auto.Wave2V(1552.2, wl2)] + [13.5, 20.3, auto.Wave2V(1550, wl2)] + [13.5, 20.3, auto.Wave2V(1551.8, wl2)]
feat = [0, 0, 0, 2, 2, 2, 2, 2, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
