...
ctn_flag = auto.mask_wl(wl, [1543, 1544.5, 1547.5, 1549.5, 1550.5, 1552.3])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1547.8, wl1)] + [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13.3, 20.3, auto.Wave2V(1549, wl1)] + [13.5, 20.3, auto.Wave2V(1552, wl2)] + [13.5, 20.3, auto.Wave2V(1548.1, wl1)] #+ [13, 20.3, auto.Wave2V(1549.2, wl2)] #+ [13.5, 20.3, auto.Wave2V(1552.4, wl2)] + [13.5, 20.3, auto.Wave2V(1551.6, wl2)] + [13.5, 20.3, auto.Wave2V(1552.5, wl2)] #+ [13.5, 20.3, auto.Wave2V(1551.8, wl2)]
feat = [1, 0, 1, 2, 0] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-80, -10]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [180, 300])
