...
ctn_flag = auto.mask_wl(wl, [1547, 1549.4, 1550.2, 1552, 1553.1, 1554])  # add custom ctn if needed 
...
x0 =[13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.3, 20.3, auto.Wave2V(1548.5, wl1)]  + [13, 20.3, auto.Wave2V(1547.4, wl1)] + [13.5, 20.3, auto.Wave2V(1548.3, wl1)] #+ [13, 20.3, auto.Wave2V(1551.5, wl2)] + [13, 20.3, auto.Wave2V(1547.8, wl1)] + [13.3, 20.3, auto.Wave2V(1552.5, wl2)]
feat = [0, 0, 0, 1] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[0, 30]) # add masking for any regions not to be used in combined data
