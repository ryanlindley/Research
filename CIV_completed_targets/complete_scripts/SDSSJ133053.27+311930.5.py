...
#ctn_flag = auto.mask_wl(wl, [1551.5, 1552.3, 1552.8, 1555])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.4, 20.3, auto.Wave2V(1548.4, wl1)] + [13.5, 20.3, auto.Wave2V(1550.4, wl2)] + [13.4, 20.3, auto.Wave2V(1552.5, wl2)] #+ [13.5, 20.3, auto.Wave2V(1550.5, wl2)] #+ [13.2, 20.3, auto.Wave2V(1552, wl2)] #+ [13, 20.3, auto.Wave2V(1547.2, wl1)] + [13, 20.3, auto.Wave2V(1548.5, wl1)]
...
weak_flag = auto.mask_v(wl, wl2, [-100, -60])
...
auto.plot_final_data(wl, wl1, wl2, N1r, N2r, v_final, Nv_final, Nve_final, name, [-300, 450])
...
auto.save_final_data_plot(wl, wl1, wl2, N1r, N2r, v_final, Nv_final, Nve_final, name, [-300, 450])
