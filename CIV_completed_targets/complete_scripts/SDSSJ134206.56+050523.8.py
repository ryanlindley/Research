...
ctn_flag = auto.mask_wl(wl, [1547.5, 1548.5])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13.5, 20.3, auto.Wave2V(1547.6, wl1)] + [13.4, 20.3, auto.Wave2V(1550.3, wl2)] + [13.5, 20.3, auto.Wave2V(1551.5, wl2)]  + [13.4, 20.3, auto.Wave2V(1547.4, wl1)] + [13.4, 20.3, auto.Wave2V(1548.6, wl1)] #+ [13.2, 20.3, auto.Wave2V(1552.5, wl2)] #+ [13.3, 20.3, auto.Wave2V(1551.5, wl2)] + [13.2, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 0, 2, 2, 1, 1] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-225, -175]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [-125, -50, 125, 175])
...
CIV_regions = [[-150, 75]]
cont_regions = [[-225, -175], [-125, -50], [125, 175]]
