...
ctn_flag = auto.mask_wl(wl, [1547.5, 1548.5, 1549.5, 1551.8])  # add custom ctn if needed 
...
x0 =[13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.3, 20.3, auto.Wave2V(1547.6, wl1)] + [13.5, 20.3, auto.Wave2V(1549.6, wl2)] + [13, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1552.5, wl2)] #+ [13.5, 20.3, auto.Wave2V(1552.5, wl2)] + [13.5, 20.3, auto.Wave2V(1550.7, wl2)] + [13.5, 20.3, auto.Wave2V(1548.6, wl1)]
feat = [0, 1, 2, 1, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-130, -100, 450, 480]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [-240, -160, 300, 400])
...
CIV_regions = [[-140, 75]]
cont_regions = [[-240, -160], [-130, -100], [300, 400], [450, 480]]
