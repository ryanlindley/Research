...
ctn_flag = auto.mask_wl(wl, [1550, 1551, 1551.8, 1552.5, 1553.8, 1555])  # add custom ctn if needed 
...
x0 =[13.5, 20.3, auto.Wave2V(1547.6, wl1)] + [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1552.4, wl2)] + [13.4, 20.3, auto.Wave2V(1552.7, wl2)] #+ [13.4, 20.3, auto.Wave2V(1552.5, wl2)] + [13.3, 20.3, auto.Wave2V(1548.3, wl1)]
