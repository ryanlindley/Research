...
#ctn_flag = auto.mask_wl(wl, [1547.8, 1549.2, 1550.4, 1551.3])  # add custom ctn if needed 
...
x0 = [14, 20.3, auto.Wave2V(1546.5, wl1)] + [13.5, 20.3, auto.Wave2V(1547.5, wl1)] + [13.3, 20.3, auto.Wave2V(1548, wl1)] + [13.3, 20.3, auto.Wave2V(1550.2, wl2)]  #+ [13, 20.3, auto.Wave2V(1547.6, wl1)] + [13, 20.3, auto.Wave2V(1551, wl2)] #+ [13, 20.3, auto.Wave2V(1548.7, wl1)]
feat = [1, 0, 0, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-400, -250]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [-150, -50])
