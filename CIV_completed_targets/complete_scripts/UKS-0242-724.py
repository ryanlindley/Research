...
ctn_flag = auto.mask_wl(wl, [1548, 1550])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548.2, wl1)] + [13.5, 20.3, auto.Wave2V(1548.6, wl1)] + [13.5, 20.3, auto.Wave2V(1549.2, wl1)] + [13.5, 20.3, auto.Wave2V(1549.5, wl1)] + [13.5, 20.3, auto.Wave2V(1549.8, wl1)] + [13.2, 20.3, auto.Wave2V(1548.4, wl1)] + [13.3, 20.3, auto.Wave2V(1547.6, wl1)] + [13.3, 20.3, auto.Wave2V(1550.5, wl2)] + [13.2, 20.3, auto.Wave2V(1551.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 1 ,0, 0, 0, 1, 1, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-50, 125]) # add masking for any regions not to be used in combined data
