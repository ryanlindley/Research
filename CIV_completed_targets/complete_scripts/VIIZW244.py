...
ctn_flag = auto.mask_wl(wl, [1547.4, 1548.2, 1550, 1552.2])  # add custom ctn if needed 
...
x0 =[13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1547.9, wl1)] + [13.5, 20.3, auto.Wave2V(1552, wl2)] + [13.5, 20.3, auto.Wave2V(1548.5, wl1)] + [13.5, 20.3, auto.Wave2V(1549.2, wl2)] + [13.3, 20.3, auto.Wave2V(1551.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1548.4, wl1)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 0, 2, 0, 2, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
weak_flag = auto.mask_v(wl, wl2, [100, 275])
