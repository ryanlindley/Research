...
ctn_flag = auto.mask_wl(wl, [1543, 1545, 1547.5, 1548.8, 1551, 1551.5, 1552.2, 1552.8])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1551.3, wl2)] + [13.5, 20.3, auto.Wave2V(1552.5, wl2)] + [13.5, 20.3, auto.Wave2V(1548.2, wl1)] #+ [13.3, 20.3, auto.Wave2V(1547.8, wl1)] #+ [13.3, 20.3, auto.Wave2V(1546.4, wl1)] #+ [13.4, 20.3, auto.Wave2V(1552, wl2)] + [13.2, 20.3, auto.Wave2V(1552.5, wl2)] #+ [13.3, 20.3, auto.Wave2V(1551.5, wl2)] + [13.2, 20.3, auto.Wave2V(1550.6, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 2, 2, 1] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-50, 40]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [50, 150, 250, 400])
...
CIV_regions = [[-200, -100], [-100, -40], [-40, 125]]
cont_regions = [[-250, -200]]
