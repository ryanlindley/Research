...
ctn_flag = auto.mask_wl(wl,   [1543, 1544.8, 1546, 1547, 1547, 1551])  # add custom ctn if needed 
...
x0 = [13.5, 20.3, auto.Wave2V(1547.9, wl1)]  + [13.5, 20.3, auto.Wave2V(1548, wl2)] + [13.2, 20.3, auto.Wave2V(1548.8, wl1)] + [13, 20.3, auto.Wave2V(1547.5, wl1)] #+ [12.5, 20.3, auto.Wave2V(1551, wl2)] + [13, 20.3, auto.Wave2V(1550.4, wl2)] #+ [13, 20.3, auto.Wave2V(1550.5, wl2)]
feat = [0, 1, 1, 1] #which features used to model 0 - both, 1 - strong, 2 - weak
