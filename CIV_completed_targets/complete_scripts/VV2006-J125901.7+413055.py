...
ctn_flag = auto.mask_wl(wl, [1543.9, 1544.8, 1547.4, 1549, 1550, 1551])  # add custom ctn if needed 
...
x0 =[13.5, 20.3, auto.Wave2V(1548, wl1)] + [13.5, 20.3, auto.Wave2V(1549, wl1)] + [13.5, 20.3, auto.Wave2V(1547.5, wl1)] + [13, 20.3, auto.Wave2V(1548.3, wl1)] + [13.5, 20.3, auto.Wave2V(1550, wl2)] + [13.3, 20.3, auto.Wave2V(1548.2, wl1)] + [13.2, 20.3, auto.Wave2V(1552, wl2)] #+ [13.5, 20.3, auto.Wave2V(1549.6, wl2)]
feat = [0, 0, 1, 1, 2, 1, 2] #which features used to model 0 - both, 1 - strong, 2 - weak
...
strong_flag = auto.mask_v(wl, wl1,[-50, 0]) # add masking for any regions not to be used in combined data
weak_flag = auto.mask_v(wl, wl2, [-160, -140, 180, 200])
...
CIV_regions = [[-140, 50], [110, 200]]
cont_regions = [[-160, -140], [-50, 0], [180, 200]]
